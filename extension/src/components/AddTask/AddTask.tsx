...
const AddTask = () => {
  ...
  const dynamicTextDetailsExtraction = (e: React.ChangeEvent<any>) => {
      ...
      <form className="flex flex-col clear-start bg-white p-5 rounded-lg">
        <div className="flex flex-row items-center bg-white justify-between">
          ...
          <input
            ...
            className="rounded-r-md bg-sky-400 p-[5px] text-xl w-30 cursor-pointer mb-5 items-center font-semibold text-white"
          />
        </div>
